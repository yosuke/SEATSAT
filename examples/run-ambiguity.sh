...
rtcon /localhost/`hostname`.host_cxt/JuliusRTC0.rtc:result /localhost/`hostname`.host_cxt/SEAT0.rtc:speechin
rtconf /localhost/`hostname`.host_cxt/SEAT0.rtc set scorelimit 0.8
